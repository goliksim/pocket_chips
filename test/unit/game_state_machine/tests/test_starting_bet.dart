...
/// [StartingBettingTest] traditional ante is posted before blinds.
void runStartingBetTraditionalAntePriorityTest(
  ProviderContainer container,
  AppRepository repository,
) async {
  final players = createPlayers(3);
...
/// [StartingBettingTest] BBA is posted after the big blind.
void runStartingBetBigBlindAntePriorityTest(
  ProviderContainer container,
  AppRepository repository,
) async {
  final players = createPlayers(3);
  final lobbyState = createLobbyState(
    players,
    smallBlindValue: 20,
    anteType: AnteType.bigBlindAnte,
    anteValue: 40,
    banks: {
      players[0].uid: 100,
      players[1].uid: 100,
