...
void addPlayer(
  ...
  if (saved) {
    ...
    if ((!thisLobby.lobbyPlayers.contains(newPlayer)) &&
        (thisLobby.lobbyPlayers.length < maxPlayerCount)) {
      newPlayer.isActive =
          !thisLobby.lobbyIsActive || thisLobby.lobbyState == 5;
      if (!isNew) {
        newPlayer.changeBank(thisLobby.lobbyBank);
      }
...
class PlayersPageState extends State<PlayersPage> {
  ...
  Widget _topBotton() => MyButton(
        side: (thisLobby.lobbyIsActive)
            ? BorderSide(width: 2.5, color: thisTheme.subsubmainColor)
            : null,
        height: stdButtonHeight,
        buttonColor: (thisLobby.lobbyIsActive)
            ...
            child: Container(
              ...
              height: stdHorizontalOffset * 2 +
                  ...
                  (stdButtonHeight * 0.75 + stdHorizontalOffset / 2) *
                      (savedPlayers.length > standartPlayerCount
                          ? standartPlayerCount
                          : savedPlayers.length),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
          ...
          child: Row(
            children: [
              AspectRatio(
                aspectRatio: 1,
                child: Icon(
                  widget.saved ? Icons.add : Icons.save,
                  color: thisTheme.onBackground,
                  size: stdIconSize,
                ),
              ),
...
class AddWindowState extends State<AddWindow> {
  ...
  Widget _settingNewPlayer() => Container(
        ...
        height: stdDialogHeight * 1.2 -
            ((widget.settingsBool || widget.isNew)
                ? 0
                : 1 * stdButtonHeight * 0.75),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: <Widget>[
            // Аватарка
                ...
                await showGeneralDialog(
                  ...
                  pageBuilder: (context, a1, a2) {
                    return PickIcon(
                      ...
                      settingsBool: widget.settingsBool,
                      isNew: widget.isNew,
                    );
                  },
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      border: Border.all(
                        width: 1.5,
                        color: (standartLogo != 'assets/faces/pokerfaces0.jpg')
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: TextFormField(
                        initialValue: widget.isNew ? '' : newName,
                    ...
                    // Bank field
                    if (widget.settingsBool || widget.isNew)
                      SizedBox(
                        height: stdButtonHeight * 0.6,
                        child: TextFormField(
                          //initialValue: widget.isNew?"":newBank,
                          controller: _bankController,
                          keyboardType: TextInputType.number,
                    ...
                    MyButton(
                      ...
                      buttonColor: (newName != '') &&
                              ((((newBank != '0')) ||
                                  ...
                                  (!thisLobby.lobbyPlayers.contains(
                                        Player(
                                          newName,
                                          standartLogo,
                                          int.parse(newBank),
                      ...
                      action: () async {
                        ...
                        if (!thisLobby.lobbyPlayers.contains(checkplayer) ||
                            (widget.player == checkplayer)) {
