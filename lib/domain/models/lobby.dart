...
import '../../data/storage/storage_notshared.dart';
...
class Player {
  ...
  @override
  int get hashCode => bank * bid * name.codeUnits.reduce((a, b) => a + b);
...
class Lobby {
  ...
  String show() {
    ...
    text += ']\n';
    text +=
        'lobbyIsActive: $lobbyIsActive\tlobbyState: $lobbyState\tdealerIndex: $dealerIndex\tfirstPlayerIndex: $firstPlayerIndex\tlobbyIndex: $lobbyIndex\n';
    text += 'lobbyBank: $lobbyBank\tlobbySmallBlind: $lobbySmallBlind\n';
    text += 'lobbyAnte: $lobbyAnte\tlobbyAutoBool: $lobbyAnteBool\n';
    text +=
        'elementsOffset: $elementsOffset\tlobbyRandomOffset: $lobbyRandomOffset\n';
  ...
  */
  ...
  Lobby.fromJson(Map<String, dynamic> json)
      :
        ...
        lobbyPlayers = json['lobbyPlayers']
            .map<Player>((i) => Player.fromJson(i))
            .toList(),
