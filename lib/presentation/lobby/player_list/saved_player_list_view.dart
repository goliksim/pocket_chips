...
import 'view_model/saved_player_list_view_model.dart';
import 'widgets/player_card.dart';

class SavedPlayerList extends StatelessWidget {
  final SavedPlayerListViewModel viewModel;
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: PlayerCard.saved(
                                        ...
                                        rightCallback: () => viewModel
                                            .usePlayer(players[index].uid),
