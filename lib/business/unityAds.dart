...
Future<void> unityInit(callback) async {
  await UnityAds.init(
    ...
    onFailed: (error, message) =>
        logs.writeLog('UnityAds: Initialization Failed: $error $message'),
  );
}
...
void showAd(String placementId, callback) {
  ...
  UnityAds.showVideoAd(
    ...
    onStart: (placementId) =>
        logs.writeLog('UnityAds: Video Ad $placementId started'),
    onClick: (placementId) =>
        logs.writeLog('UnityAds: Video Ad $placementId click'),
...
Widget unityBanner() => UnityBannerAd(
      ...
      onLoad: (placementId) =>
          logs.writeLog('UnityAds: Banner loaded: $placementId'),
      onClick: (placementId) =>
          logs.writeLog('UnityAds: Banner clicked: $placementId'),
